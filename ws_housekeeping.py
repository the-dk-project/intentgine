...
from func import gdrive, db
from func.ingestion import dataframe
...
gdrive.process_ingestion(TCI_id, CURRENT_DATE, 'prod', 'delivered_leads_tci', 'MySQL', ingestion.TCI, dataframe.tci_dataframe, 0)
